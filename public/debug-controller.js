...
AFRAME.registerComponent('debug-controller', {
  ...
  init: function () {
    ...
    document.addEventListener('keydown', evt => {
      ...
      if (evt.key === 'i') { primaryPosition.y += movementDelta }  
      if (evt.key === 'l') { primaryPosition.x += movementDelta }  
      if (evt.key === 'u') { primaryPosition.z -= movementDelta }  // ;.
      if (evt.key === 'o') { primaryPosition.z += movementDelta }  // ;.
      ...
      if (evt.key === 's') { secondaryPosition.y -= movementDelta }  
      if (evt.key === 'w') { secondaryPosition.y += movementDelta }  
      if (evt.key === 'd') { secondaryPosition.x += movementDelta }  
      if (evt.key === 'e') { secondaryPosition.z -= movementDelta }  // ;.
      if (evt.key === 'q') { secondaryPosition.z += movementDelta }  // ;.
