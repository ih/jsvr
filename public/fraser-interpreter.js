...
var Interpreter = function(code, opt_initFunc) {
  ...
  // Run the polyfills.
  this.ast = cherow.parse(this.polyfills_.join('\n'), Interpreter.PARSE_OPTIONS);
...
Interpreter.prototype.initFunction = function(scope) {
  ...
  wrapper = function(var_args) {
    ...
    try {
      var ast = cherow.parse('(function(' + argsStr + ') {' + code + '})',
          Interpreter.PARSE_OPTIONS);
    } catch (e) {
  ...
  if (!state.doneExec_) {
    ...
    if (funcNode) {
      ...
      if (typeof code !== 'string') {
        ...
        try {
          var ast = cherow.parse(String(code), Interpreter.PARSE_OPTIONS);
        } catch (e) {
          // Acorn threw a SyntaxError.  Rethrow as a trappable error.
...
const FraserInterpreter = Interpreter;
export { FraserInterpreter };