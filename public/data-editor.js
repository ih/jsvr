...
export default class DataEditor {
  ...
  renderKey(key, index) {
    ...
    textElement.setAttribute('position', {x: -1 * AugmentedNode.WIDTH/2, y: index * yMargin});
  ...
  renderEditableValue(key, value, index) {
    ...
    editButton.setAttribute('radius-outer', ArrayNodePort.PORT_SIZE * .5);
    editButton.setAttribute('radius-inner', ArrayNodePort.PORT_SIZE * .25);
    editButton.setAttribute('position', {x: -1 * ArrayNodePort.PORT_SIZE * .5})
